  ...
  return (
    <section className="px-6 md:px-12 py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="bg-primary border border-border relative overflow-hidden min-h-[300px] md:min-h-[400px]">
          <img
            src={terminalPreview}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-16 h-16 rounded-full bg-primary-foreground/20 backdrop-blur-sm flex items-center justify-center border border-primary-foreground/30">
